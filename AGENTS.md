...
- Canonical channel roadmap: Phase 3 contains Facebook, Instagram and WhatsApp; Phase 7 contains TikTok, X/Twitter, Discord and a non-binding OnlyFans evaluation; Phase 8 contains LinkedIn and all remaining later platform connections. Phase 8 has not started and must not be implemented or counted as progress in the current work scope.
