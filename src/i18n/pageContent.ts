...
export const pageContent: Record<Locale, PageContent> = {
  de: {
    ...
    pricingTitle: "Fan-Stufen fuer wiederkehrende Einnahmen.",
    pricingText: "FanMind ermoeglicht Creatorn eigene Mitgliedschaftsstufen und exklusive Vorteile pro Fanclub.",
    loginTitle: "Zurueck in deinen Fanclub.",
    loginText: "Diese Seite ist der erste Login-Mockup fuer Creator, Fans und Admins.",
    registerTitle: "Starte deinen FanMind Club.",
    registerText: "Creator koennen hier spaeter ihr Profil anlegen, Fan-Stufen definieren und ihren digitalen Fanclub starten.",
    dashboardTitle: "Verwalte deinen Fanclub.",
    dashboardText: "Ein erstes Dashboard fuer Fans, Mitglieder, Einnahmen, Inhalte und Community-Aktivitaet.",
    creatorTitle: "Mia Active Club",
    creatorText: "Ein Demo-Creator-Profil mit freien, Mitglieder- und Premium-Inhalten.",
    onboardingTitle: "In fuenf Schritten zum eigenen Fanclub.",
    onboardingText: "Ein gefuehrter Einstieg vom Profil bis zum ersten veroeffentlichten Fanclub-Link.",
    adminTitle: "Plattformuebersicht.",
    adminText: "Ein erster Adminbereich fuer Nutzer, Creator, Inhalte und Plattformkontrolle.",
    open: "Oeffnen",
    selectDemo: "Demo auswaehlen",
