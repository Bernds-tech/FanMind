...
const sections: LegalSection[] = [
  { title: "Anbieter und Projektkontakt", body: ["FanMind ist ein KI-gestütztes CRM- und Kommunikationssystem für Fan-Beziehungen mit manuellem Copy-&-Open-Workflow.", "Kontakt für Anbieter- und Projektanfragen: kontakt@fanmind.de", "Website: https://fanmind.ch"] },
  { title: "Kommunikation und Support", body: ["Für Support-, Pilot- und Vertragsfragen ist kontakt@fanmind.de der zentrale Kontakt.", "Datenschutzanfragen können an privacy@fanmind.ch oder kontakt@fanmind.de gerichtet werden."] },
