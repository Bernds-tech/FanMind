  ...
  return (
    <main id="top" className={styles.page}>
      ...
      <div className={styles.shell}>
        ...
        <article className={styles.content} aria-label="FanMind Referral-Teilnahmebedingungen">
          ...
          <section className={styles.section}>
            <h2>3. Zuordnung einer Empfehlung</h2>
            <p>
          ...
          <section className={styles.section}>
            <h2>5. Aktivierung und Wegfall</h2>
            <p>
          ...
          <section className={styles.section}>
            <h2>6. Globales Growth Window</h2>
            <p>
          ...
          <section className={styles.section}>
            <h2>7. Datenschutz und Transparenz</h2>
            <p>
              Empfehlenden werden nur die für ihren Programmstatus notwendigen Status-
              und Rabattinformationen angezeigt. Fremde Kontakt-, Vertrags- oder
              Zahlungsdaten werden nicht offengelegt. Weitere Informationen stehen in der{
              " "
              }<Link href="/datenschutz">Datenschutzerklärung</Link>.
            </p>
          </section>
          ...
          <section className={styles.section}>
            <h2>8. Programmstatus und Änderungen</h2>
            <p>
