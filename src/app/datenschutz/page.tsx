...
const sections: LegalSection[] = [
  { title: "Verantwortlicher und Kontakt", body: ["Kontakt für Datenschutzanfragen: privacy@fanmind.ch oder anfrage@fanmind.ch.", "Die konkrete Verantwortlichenangabe wird im Vertrags- und Anbieterprozess finalisiert, ohne unbestätigte Firmendaten öffentlich zu behaupten."] },
