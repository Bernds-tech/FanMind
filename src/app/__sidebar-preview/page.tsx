...
const mainNavigation: WorkspaceNavLink[] = [
  { label: "Dashboard", href: "/__sidebar-preview", icon: "dashboard", active: true },
  { label: "Fans", href: "/__sidebar-preview#fans", icon: "contacts" },
  { label: "Follow-ups", href: "/__sidebar-preview#followups", icon: "followups", badge: "3" },
  { label: "Kanäle", href: "/__sidebar-preview#channels", icon: "channels", badge: "Sync" },
];

const settingsNavigation: WorkspaceNavLink[] = [
  { label: "Profil & Konto", href: "/__sidebar-preview#profile", icon: "profile" },
  { label: "Adminbereich", href: "/__sidebar-preview#admin", icon: "admin" },
];

const savedViews: WorkspaceNavLink[] = [
  { label: "Top Fans", href: "/__sidebar-preview#top-fans", icon: "topFans" },
  { label: "Reaktivierung", href: "/__sidebar-preview#reactivation", icon: "reactivation" },
];
  ...
  return (
    <WorkspaceShell
      ...
      header={{
        ...
        primaryActionHref: "/__sidebar-preview",
      }}
      contactCount={312}
      openFollowupCount={3}
      logoutAction={previewLogout}
      profileHref="/__sidebar-preview#profile"
    >
      <main
