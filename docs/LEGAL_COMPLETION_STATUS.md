...
- [ ] unterzeichnungsfähige AVV mit Parteien, Gegenstand, Dauer, Weisungen, Datenarten, Personengruppen, TOM, Löschung/Rückgabe und Unterstützungspflichten
- [ ] aktuelle Liste der Unterauftragsverarbeiter und Verarbeitungsregionen
- [ ] Drittland-/Transfergrundlagen, soweit relevant
- [ ] konkrete Aufbewahrungs- und Löschfristen je Datenart
...
- [ ] CI verhindert alte Kontaktadressen, veraltete Preise und öffentliche Platzhalter.
- [ ] Production-Smoke-Test prüft `/impressum`, `/datenschutz`, `/avv`, `/agb` und `/zahlungsbedingungen`.
