...
Track implementation ordering and cross-project/external prerequisites here. Do not mark a dependent task accepted while a required dependency remains unresolved.

## FM-DEP-001
- From: FM-RST-001
- Requires: existing reviewed restore workflow, protected restore-drill environment, approved runner-group policy and isolated PostgreSQL target
