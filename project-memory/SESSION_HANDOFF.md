...
- Exact current step: do not dispatch the database workflow. Wait for a new exact protected R4 authorization naming commit, accepted backup/source binding, isolated target and two fresh sequential one-job JITs; then repeat the mutable-evidence preflight.
