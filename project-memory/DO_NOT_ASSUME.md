...
## Working rule
When a planned action depends on a drift-prone fact, record the revalidation result in `EVIDENCE.md`, `CURRENT_STATE.md` or the related task before proceeding.
